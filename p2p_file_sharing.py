...
BUFFER_SIZE = 1024       # Size of data chunks for file transfer
SHARED_FOLDER = "shared" # Folder to store shared files
DOWNLOADS_FOLDER = "downloads" # Folder to store downloaded files

# Ensure the shared and downloads folders exist
...
# Global variables to store the dynamically assigned server IP and port
SERVER_IP = None
SERVER_PORT = None
...
def start_server(gui_update_network_details):
    ...
    server_socket.bind((SERVER_HOST, 0))  # Bind to any available port
